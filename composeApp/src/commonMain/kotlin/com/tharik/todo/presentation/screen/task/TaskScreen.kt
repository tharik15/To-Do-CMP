...
import com.tharik.todo.presentation.component.PriorityChip
import com.tharik.todo.presentation.component.PriorityChipSize
        ...
        Column(
            ...
            Box(modifier = Modifier.padding(all = 16.dp)) {
                Button(
                    ...
                    Text(
                        text = if (id != null) "Update Notes" else "Create Notes"
                    )
                }
            }
        }
